...
Tel. No: 312 507 5656. """,
        ...
        text = re.sub(
            r,
            """ Türkiye Cumhuriyet Merkez Bankası Central Bank of the Republic of Turkey Head Office Hacı Bayram Mah İstiklal Cad No Ulus Altındağ Ankara """,
            "",
            text,
        )
...
with open("corpus/cleaned_corpus.txt", "w") as f:
    f.write(corpus_text)
